...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#text02', { style: 'zoom-in', speed: 2750, intensity: 10, threshold: 4, delay: 0, replay: false });
		onvisible.add('#text04', { style: 'fade-right', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text07', { style: 'fade-in', speed: 375, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text01', { style: 'fade-in', speed: 375, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text09', { style: 'fade-in', speed: 375, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#buttons04', { style: 'fade-down', speed: 1000, intensity: 1, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('#text11', { style: 'fade-in', speed: 375, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#buttons02', { style: 'fade-down', speed: 1000, intensity: 1, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('#text13', { style: 'fade-in', speed: 375, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#buttons01', { style: 'fade-down', speed: 1000, intensity: 1, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('#text05', { style: 'fade-in', speed: 375, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text06', { style: 'fade-in', speed: 375, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text10', { style: 'fade-in', speed: 375, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#buttons03', { style: 'fade-down', speed: 1000, intensity: 1, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('#text12', { style: 'fade-in', speed: 375, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text03', { style: 'fade-in', speed: 375, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#icons03', { style: 'fade-down', speed: 875, intensity: 1, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
